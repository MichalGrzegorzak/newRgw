...
namespace NHibernate.Validator.Constraints
{
	...
	public class OptionDigitsAttribute : EmbeddedRuleArgsAttribute, IRuleArgs, IValidator
	{
		private string message = "{validator.digits}";
		public OptionDigitsAttribute() {}

		public OptionDigitsAttribute(int maxIntegerDigits)
		{
			IntegerDigits = maxIntegerDigits;
		}

		public OptionDigitsAttribute(int maxIntegerDigits, int maxFractionalDigits)
	...
	public static class IntegerConstraintsExtensions
	{
		public static IChainableConstraint<IIntegerConstraints> IfNotEmptyDigits(this IIntegerConstraints definition,
			int maxIntegerDigits)
		{
			var ruleArgs = new OptionDigitsAttribute(maxIntegerDigits);
			((IConstraints)definition).AddRuleArg(ruleArgs);
			return new ChainableConstraint<IIntegerConstraints>(definition, ruleArgs);
		}
	}
}