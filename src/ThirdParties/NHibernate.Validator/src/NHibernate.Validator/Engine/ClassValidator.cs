...
namespace NHibernate.Validator.Engine
{
	...
	public class ClassValidator : IClassValidator, IClassValidatorImplementor, ISerializable 
	{
		...
		public IEnumerable<InvalidValue> GetPotentialInvalidValues(string propertyName, object value, params object[] tags)
		{
			...
			{
				//Walidujesz property, ktore nie posiada przypisanej zadnej walidacji !!!
				throw new TargetException(string.Format("Walidujesz pole, ktorego nie ma!. The property or field '{0}' was not found in class {1}", propertyName,
																								entityType.FullName));
			}
