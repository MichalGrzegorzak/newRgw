...
namespace Kanc.UI.Forms
{
        public class EventPublisher
        {
            ...
            public static void Publish<T>(T eventToPublish, BaseFormSessionRozlicz publishedBy)
            {
            ...
            {
                Debug.Assert(action.Target is BaseFormSessionRozlicz);
                lock (Subscribers)
                {
                    ...
                    //        MethodInvoker.Invoke((Action)delegate                                                
                    //        {
                    //            action((T) o);
                    //        });
                    //    }
                    ...
                    //    }
                    //};
                    ((BaseFormSessionRozlicz)action.Target).Disposed += (s, e) => Unregister<T>(item);
                    value.Add(item);
                }
            }
