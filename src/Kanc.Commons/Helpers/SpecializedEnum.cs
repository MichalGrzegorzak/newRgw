...
namespace Kanc.Commons
{
        ...
        where TValues : IComparable
    {
        ...
        private static readonly SortedList<TValues, string> keyValueDescription = new SortedList<TValues, string>();
        ...
        public static void AddDesc(TValues name, string desc)
        {
            keyValueDescription.Add(name, desc);
        }

        public static string GetDescr(TValues name)
        {
            return keyValueDescription[name];
        }
        ...
        /// </returns>
        public static bool IsDefined(TValues value) { return keyValuePairs.ContainsValue(value); }
    ...
    //{
    //    public static string GetDescr(this SpecializedEnum<TDerived, TValues> enm, string desc) where TDerived : SpecializedEnum<TDerived, TValues>
    //    where TValues : IComparable
    //    {
    //        return keyValueDescription[name];
    //    }
