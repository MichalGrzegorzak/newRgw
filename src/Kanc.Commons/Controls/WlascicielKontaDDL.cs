...
namespace Kanc.Commons
{
    ...
    public class WlascicielKontaDDL : ComboBox
    {
        public WlascicielKontaDDL()
            : base()
        {
        ...
        public void LoadData()
        {
            ...
            IList list = typeof(KontoWlasciciel).ToExtendedList<int>();
        ...
        public KontoWlasciciel SetValue
        {
            get
            {
